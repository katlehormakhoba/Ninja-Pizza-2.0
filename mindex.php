...
// MY QUERY
$query_c ="select count(*) as b from cart where u_id = '$u_id'";
//MAKE QUERY
            ...
            <div class="col s6 md3 hoverable z-depth-2">
                <div class="card">
                    <div class="card-image ">
                        <img src="<?php echo htmlspecialchars($pizza['url']); ?>">
                    </div>
                ...
                <div class="card-action">
                    <a href="mdetails.php?p_id=<?php echo $pizza['p_id']; ?>" class="btn">More details</a>
                </div>
            </div>
        <?php endforeach; ?>
        </div>
