...
{
    $p_id = $_GET['p_id'];
    $query_update = "select * from pizza where p_id = '$p_id'";
    $results_update = mysqli_query($conn, $query_update);
    $pizza = mysqli_fetch_array($results_update);
...
//VALIDATION FOR ENTERY
	...
	else
	{
		...
		// MY QUERY
        $insert = "update pizza
        set title = '$title', creater = '$name', ingredients = '$ingredients', price = '$price', url = '$url'
        where p_id = '$p_id'";
...
<section class="container ">
	...
	<form class="white transparent" action="medit.php" method="POST">
		<label>Enter Your Name</label>
		<input type="text" name="name" value="<?php echo htmlspecialchars($name)?>">
		<div class="red-text"><?php echo $errors['name']?></div>

        <label for="disabled">Pizza ID</label>
		<input type="text" id="disabled" name="p_id" disabled value="<?php echo htmlspecialchars($p_id)?>">
