...
<h4 class="center grey-text">Your History</h4>
...
<table>
        ...
        <?php foreach($lists as $list) : ?>
          <tr>
            ...
            <td><a href="more.php?p_id=<?php echo $list['p_id']?>&&c_id=<?php echo $list['c_id']?>" class="btn right">More Info</a></td>
          </tr>
          <?php endforeach; ?>
        </tbody>
      </table>
      <h4 class="center">Total Amount Paid : <?php echo $due[0]['due'];?></h4>
</div>
